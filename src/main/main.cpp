...
//    textEditor->setName("Text Editor");
    ...
    if (defaultCtrl == -1) {
        auto devView = new ZDevViewController(argv);
        ZApplication(devView, "zpath", false, 2100, 1000, "resources/icons/zpath.png", [](){});
    } else {
        ...
        }, {"3D Viewport", "Node Editor", "Text Editor", "Calculator", "Developer", "Settings", "Data Import",
            "JSON Editor"}, true, nullptr);
