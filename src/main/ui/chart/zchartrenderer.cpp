...
void ZChartRenderer::onDraw() {
    ...
    mat4 projection = ortho(0.0f, (float) 1.0, (float) mMax, mMin, -1.0f, 10.0f);
...
void ZChartRenderer::setZPosition(float zPosition) {
    mZPosition = zPosition + 0.02;
}
